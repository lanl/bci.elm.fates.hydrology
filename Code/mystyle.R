...
current.folder <- "2019-10-14_5000/trial2"
if(!dir.exists(file.path("data-raw", current.folder))) {dir.create(file.path("data-raw", current.folder))}
if(!dir.exists(file.path("data", current.folder))) {dir.create(file.path("data", current.folder))}
...
par.on <- par.on.1[rep(row.names(par.on.1), 4),]
nsam <- length(par.on$par.sam) 
rmse.table <- data.frame(par.sam = par.on$par.sam, "qrunoff_daily" = rep(NA, nsam), n = c(7007:7010))
rsq.table <- data.frame(par.sam = par.on$par.sam, "qrunoff_daily" = rep(NA, nsam), n = c(7007:7010))
nse.table <- data.frame(par.sam = par.on$par.sam, "qrunoff_daily" = rep(NA, nsam), n = c(7007:7010))
###
...
col2 <- c("Observed" = "#f04546", "Depth 0.5m at CRF ~1" = "purple", 
          "Depth 1m at CRF ~1" = "magenta", "Depth 2m at CRF ~1" = "blue", "Half BBslope+ Half Vcmax" = "green")

p.qrun.d <- ggplot(qrunoff.d.long.sub,
       aes(x = date, y = value)) +
  geom_line(data = qrunoff.d.long.sub %>% subset(par.sam == 7007), aes(group = par.sam, color = "Half BBslope+ Half Vcmax"), show.legend = F, size = 0.5) +
  geom_line(data = qrunoff.d.long.sub %>% subset(par.sam == 7008), aes(group = par.sam, color = "Depth 0.5m at CRF ~1"), show.legend = F, size = 0.5) +
  geom_line(data = qrunoff.d.long.sub %>% subset(par.sam == 7009), aes(group = par.sam, color = "Depth 1m at CRF ~1"), show.legend = F, size = 0.5) +
  geom_line(data = qrunoff.d.long.sub %>% subset(par.sam == 7010), aes(group = par.sam, color = "Depth 2m at CRF ~1"), show.legend = F, size = 0.5) +
...
p.qrun.m <- ggplot(qrunoff.m.long.sub,
       aes(x = date, y = value)) +
  geom_line(data = qrunoff.m.long.sub %>% subset(par.sam == 7007), aes(group = par.sam, color = "Half BBslope+ Half Vcmax"), show.legend = F, size = 0.5) +
  geom_line(data = qrunoff.m.long.sub %>% subset(par.sam == 7008), aes(group = par.sam, color = "Depth 0.5m at CRF ~1"), show.legend = F, size = 0.5) +
  geom_line(data = qrunoff.m.long.sub %>% subset(par.sam == 7009), aes(group = par.sam, color = "Depth 1m at CRF ~1"), show.legend = F, size = 0.5) +
  geom_line(data = qrunoff.m.long.sub %>% subset(par.sam == 7010), aes(group = par.sam, color = "Depth 2m at CRF ~1"), show.legend = F, size = 0.5) +
  geom_line(aes(y = obs, colour = "Observed"), size = 0.5) +
...
write.csv(qrunoff.d.sub, file = file.path("data", current.folder, "qrunoff.d.sub.csv"), row.names = FALSE)
write.csv(qrunoff.m, file = file.path("data", current.folder, "qrunoff.m.csv"), row.names = FALSE)
...
p.et1.d <- ggplot(qet.d.long.sma, aes(x = date, y = value)) +
  geom_line(data = qet.d.long.sma %>% subset(par.sam == 7007), aes(group = par.sam, color = "Half BBslope+ Half Vcmax"), show.legend = F, size = 0.5) +
  geom_line(data = qet.d.long.sma %>% subset(par.sam == 7008), aes(group = par.sam, color = "Depth 0.5m at CRF ~1"), show.legend = F, size = 0.5) +
  geom_line(data = qet.d.long.sma %>% subset(par.sam == 7009), aes(group = par.sam, color = "Depth 1m at CRF ~1"), show.legend = F, size = 0.5) +
  geom_line(data = qet.d.long.sma %>% subset(par.sam == 7010), aes(group = par.sam, color = "Depth 2m at CRF ~1"), show.legend = F, size = 0.5) +
...
write.csv(qet.sma, file = file.path("data", current.folder, "qet.sma.csv"), row.names = FALSE)
write.csv(qet.sp, file = file.path("data", current.folder, "qet.sp.csv"), row.names = FALSE)
write.csv(qet.d, file = file.path("data", current.folder, "qet.d.csv"), row.names = FALSE)
write.csv(qet.m, file = file.path("data", current.folder, "qet.m.csv"), row.names = FALSE)
...
write.csv(gpp.d.sub, file = file.path("data", current.folder, "gpp.d.sub.csv"), row.names = FALSE)
write.csv(gpp.m, file = file.path("data", current.folder, "gpp.m.csv"), row.names = FALSE)
...
write.csv(nse.table, file = file.path("data", current.folder, "nse.table.csv"), row.names = FALSE)
write.csv(rsq.table, file = file.path("data", current.folder, "rsq.table.csv"), row.names = FALSE)

params.nse <- par.on %>% full_join(nse.table, by = "par.sam")
write.csv(params.nse, file = file.path("data", current.folder, "params.nse.csv"), row.names = FALSE)
params.rsq <- par.on %>% full_join(rsq.table, by = "par.sam")
write.csv(params.rsq, file = file.path("data", current.folder, "params.rsq.csv"), row.names = FALSE)
best.params.nse <- params.nse[which(params.nse$par.sam %in% c(max.par.n.run.d, max.par.n.et.d, max.par.n.swc.d)),]
write.csv(best.params.nse, file = file.path("data", current.folder, "best.params.nse.csv"), row.names = FALSE)
...
g1 <- ggplot(swc.d.long.sub.mini, aes(x = date, y = value)) +
  geom_line(aes(x= date, y = obs, color = "Observed"), size = 0.5) +
  geom_line(data = swc.d.long.sub.mini %>% subset(par.sam == 7007), aes(group = par.sam, color = "Half BBslope+ Half Vcmax"), show.legend = F, size = 0.5) +
  geom_line(data = swc.d.long.sub.mini %>% subset(par.sam == 7008), aes(group = par.sam, color = "Depth 0.5m at CRF ~1"), show.legend = F, size = 0.5) +
  geom_line(data = swc.d.long.sub.mini %>% subset(par.sam == 7009), aes(group = par.sam, color = "Depth 1m at CRF ~1"), show.legend = F, size = 0.5) +
  geom_line(data = swc.d.long.sub.mini %>% subset(par.sam == 7010), aes(group = par.sam, color = "Depth 2m at CRF ~1"), show.legend = F, size = 0.5) +
  theme(legend.position = "top") +
...
write.csv(swc.d.long, file = file.path("data", current.folder, "swc.d.long.csv"), row.names = FALSE)
write.csv(swc.d.vert.long, file = file.path("data", current.folder, "swc.d.vert.long.csv"), row.names = FALSE)
...
qrunoff.m <- read.csv(file = file.path("data", current.folder, "qrunoff.m.csv"), header = TRUE)
qet.m <- read.csv(file = file.path("data", current.folder, "qet.m.csv"), header = TRUE)
swc.d.long  <- read.csv(file = file.path("data", current.folder, "swc.d.long.csv"), header = TRUE)
swc.d.long.vert <- read.csv(file = file.path("data", current.folder, "swc.d.vert.long.csv"))
...
write.csv(max.nse, file = file.path("data", current.folder, "max.nse.csv"), row.names = FALSE)
...
write.csv(max.rsq, file = file.path("data", current.folder, "max.rsq.csv"), row.names = FALSE)
# par.sam   qrunoff_daily qrunoff_monthly       qet_daily     qet_monthly       gpp_daily     gpp_monthly     swc10_daily     swc40_daily 
