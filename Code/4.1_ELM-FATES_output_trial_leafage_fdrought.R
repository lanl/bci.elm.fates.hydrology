...
col2 <- c("Observed" = "#f04546",  "leafage" = "blue",  
          "leafage_fdrought" = "black", "Vcmax 50" = "magenta")
...
rmse.table <- data.frame(par.sam = par.on$par.sam, "qrunoff_daily" = rep(NA, nsam), n = c(7002, 7003, 7004))
rsq.table <- data.frame(par.sam = par.on$par.sam, "qrunoff_daily" = rep(NA, nsam), n = c(7002, 7003, 7004))
nse.table <- data.frame(par.sam = par.on$par.sam, "qrunoff_daily" = rep(NA, nsam), n = c(7002, 7003, 7004))
...
p.lai.m <- ggplot(lai.m.long.sub,
                   aes(x = date, y = value)) +
  geom_point(data = lai.m.long.sub %>% subset(par.sam == 7002), aes(group = par.sam, color = "leafage"), show.legend = F, size = 0.5) +
  geom_point(data = lai.m.long.sub %>% subset(par.sam == 7003), aes(group = par.sam, color = "Vcmax 50"), show.legend = F, size = 0.5) +
  geom_point(data = lai.m.long.sub %>% subset(par.sam == 7004), aes(group = par.sam, color = "leafage_fdrought"), show.legend = F, size = 0.5) +
  ...
  theme(legend.text = element_text(size = 16, face = "plain"),
        legend.position = c(0.2, 0.2), legend.background = element_rect(fill = "transparent")) +
...
p.qrun.d <- ggplot(qrunoff.d.long.sub,
       aes(x = date, y = value)) +
  geom_line(data = qrunoff.d.long.sub %>% subset(par.sam == 7002), aes(group = par.sam, color = "leafage"), show.legend = F, size = 0.5) +
  geom_line(data = qrunoff.d.long.sub %>% subset(par.sam == 7003), aes(group = par.sam, color = "Half Vcmax"), show.legend = F, size = 0.5) +
  geom_line(data = qrunoff.d.long.sub %>% subset(par.sam == 7004), aes(group = par.sam, color = "leafage_fdrought"), show.legend = F, size = 0.5) +
...
p.qrun.m <- ggplot(qrunoff.m.long.sub,
       aes(x = date, y = value)) +
  geom_line(data = qrunoff.m.long.sub %>% subset(par.sam == 7002), aes(group = par.sam, color = "leafage"), show.legend = F, size = 0.5) +
  geom_line(data = qrunoff.m.long.sub %>% subset(par.sam == 7003), aes(group = par.sam, color = "Half Vcmax"), show.legend = F, size = 0.5) +
  geom_line(data = qrunoff.m.long.sub %>% subset(par.sam == 7004), aes(group = par.sam, color = "leafage_fdrought"), show.legend = F, size = 0.5) +
  geom_line(aes(y = obs, colour = "Observed"), size = 0.5) +
...
p.et1.p <- ggplot(qet.d.long.points, aes(x = date, y = value)) +
  ...
  geom_point(aes(x= date, y = obs.2, color = "Observed"), size = 1, shape = 1) +  
  theme(legend.position = "top") +
  scale_colour_manual(name = "", values = col2) +
  ylab("ET [mm/day]") +
  xlab("Date") + 
  scale_x_date(date_breaks = "1 year", labels = function(x) format(x, "%b%y"))
p.et.p.fdrought <-  p.et1.p +
  geom_line(data = qet.d.long.points %>% subset(par.sam == 7004), aes(group = par.sam, color = "leafage_fdrought"), show.legend = F, size = 0.2)
ggsave(paste0("ET_Obs_vs_model_daily_all_years_points_lines_fdrought.jpeg"), plot = p.et.p.fdrought, path = file.path("figures", current.folder), device = "jpeg", height = 3, width = 15, units='in')
p.et.p.leafage <-  p.et1.p +
geom_line(data = qet.d.long.points %>% subset(par.sam == 7002), aes(group = par.sam, color = "leafage"), show.legend = F, size = 0.2)
ggsave(paste0("ET_Obs_vs_model_daily_all_years_points_lines_leafage.jpeg"), plot = p.et.p.leafage, path = file.path("figures", current.folder), device = "jpeg", height = 3, width = 15, units='in')
p.et.p.vcmax50 <-  p.et1.p +
  geom_line(data = qet.d.long.points %>% subset(par.sam == 7003), aes(group = par.sam, color = "Vcmax 50"), show.legend = F, size = 0.2)
ggsave(paste0("ET_Obs_vs_model_daily_all_years_points_lines_vcmax50.jpeg"), plot = p.et.p.vcmax50, path = file.path("figures", current.folder), device = "jpeg", height = 3, width = 15, units='in')


p.et1.d <- ggplot(qet.d.long.sma, aes(x = date, y = value)) +
  geom_line(data = qet.d.long.sma %>% subset(par.sam == 7002), aes(group = par.sam, color = "leafage"), show.legend = F, size = 0.5) +
  geom_line(data = qet.d.long.sma %>% subset(par.sam == 7003), aes(group = par.sam, color = "Vcmax 50"), show.legend = F, size = 0.5) +
  geom_line(data = qet.d.long.sma %>% subset(par.sam == 7004), aes(group = par.sam, color = "leafage_fdrought"), show.legend = F, size = 0.5) +
  geom_line(aes(x= date, y = sp, color = "Observed"), size = 0.5) +  
  theme(legend.position = "top") +
  scale_colour_manual(name = "", values = col2) +
  ylab("ET [mm/day]") +
...
p.et1.m.p <- ggplot(qet.m.long.sub, aes(x = date, y = value)) +
  geom_line(data = qet.m.long.sub %>% subset(par.sam == 7002), aes(group = par.sam, color = "leafage"), show.legend = F, size = 0.2) +
  geom_line(data = qet.m.long.sub %>% subset(par.sam == 7003), aes(group = par.sam, color = "Vcmax 50"), show.legend = F, size = 0.2) +
  geom_line(data = qet.m.long.sub %>% subset(par.sam == 7004), aes(group = par.sam, color = "leafage_fdrought"), show.legend = F, size = 0.2) +
...
p.gpp.d <- ggplot(gpp.d.long.sma,
       aes(x = date, y = value)) +
  geom_line(data = gpp.d.long.sma %>% subset(par.sam == 7002), aes(group = par.sam, color = "leafage"), show.legend = F, size = 0.5) +
  geom_line(data = gpp.d.long.sma %>% subset(par.sam == 7003), aes(group = par.sam, color = "Vcmax 50"), show.legend = F, size = 0.5) +
  geom_line(data = gpp.d.long.sma %>% subset(par.sam == 7004), aes(group = par.sam, color = "leafage_fdrought"), show.legend = F, size = 0.5) +
  scale_colour_manual(name = "", values = col2) +
